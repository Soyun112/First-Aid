...
export const PROJECTOR_FALLBACKS = {
  preop:
    '지금은 수술 전 검사실로 천천히 이동하고 있어요. 약 5분 정도면 도착하니 마음 편히 누워 계셔도 됩니다. 옆에 의료진이 함께 있으니 걱정하지 않으셔도 괜찮아요.',
  ward:
    '지금은 병동으로 안전하게 이동 중이에요. 천천히 가고 있으니 편안히 계셔도 됩니다. 곧 도착할 예정이니 안심하셔도 괜찮아요.',
};
